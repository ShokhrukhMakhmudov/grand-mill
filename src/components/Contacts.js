    ...
    <motion.section
      ...
      <div className="container">
        ...
        <div className="flex flex-col gap-10 lg:flex-row justify-between">
          <div className="bg-primary p-10 flex flex-col gap-5 w-full lg:w-1/2 ">
          ...
          <div className="text-center text-white text-lg font-medium">
            <p>Адрес:</p>
            <Link
              href="https://maps.windows.com/?form=WNAMSH&collection=point.40.381573_71.832322_Point"
              target="_blank"
              className="hover:text-[#F67330]">
              г. Фергана, ул. Ёруглик, 13
            </Link>
          </div>
          <div className="text-center text-white text-lg font-medium">
            <p>Почта:</p>
            <p>apolloninjiniring@gmail.com</p>
          </div>
          <div className="text-center text-white text-lg font-medium">
            <p>Телефон:</p>
            <Link
              href="tel:+998908420003"
              className="underline hover:text-[#F67330]">
              +998 90 842 00 03
            </Link>
          </div>
        </div> */}
